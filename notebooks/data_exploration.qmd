...
sns.histplot(
    ...
    log_scale=True, binrange=(-1, 9), bins=20,
    ax=ax
)
...
fig.suptitle(
    ...
    x=ax.get_position().get_points()[0][0],
    y=ax.get_position().get_points()[1][1] * 1.1
    )
...
ax.set(
    xlabel="n Times Fined", ylabel=None,
