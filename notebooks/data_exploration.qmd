...
According to this data. Facebook/Meta have had to pay: `{python} f"{controller_stats.total_price.max():,}"`
...
# some controller names don't relate to companies or are uninformative
