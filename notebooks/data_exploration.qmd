...
The minumum value of fines is 0. This seems incorrect (and worth investigating!) but with the assumption that fines should fall in the range $0 \gt \textrm{fine amount} \gt \infty$. Before performing analysis a minor amount of cleaning is required for the 'raw' data
...
For the fines referenced over 30 times, how are the fines distributed. Here each point on the plot relates to a fine of that article. That is, if there is an violation instance where articles 5, and 13 were referenced, there will be a point for article 5 and article 13 at $y = total_fine_euro$.
